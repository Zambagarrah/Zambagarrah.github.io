...
const KNOWLEDGE: Record<string, string> = {
  ...
  experience: "Zablon is a Data Analyst & Engineer at ByteForge Devs (Jan 2024–Present) and a Software Engineer & Programming Educator at Swahilipot Hub Foundation (May 2025–May 2026).",
