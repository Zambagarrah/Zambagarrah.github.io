const experiences = [
  {
    ...
    type: 'Hybrid',
    highlights: [
      'Extract, clean, and analyse large datasets, maintaining ETL pipelines and validation scripts in Python that process 10,000+ records daily across structured and unstructured sources.',
      'Optimised PostgreSQL queries and schema design, improving dashboard and report response times by up to 30%.',
      'Ran exploratory data analysis to spot trends and patterns, delivering data-driven recommendations that helped business teams identify growth opportunities.',
      'Cut manual QA review time by roughly 40% by automating data validation checks end to end, from ingestion through to output.',
      'Integrated third-party data APIs into production systems and supported backend infrastructure with Django and REST APIs, strengthening reliability through Git-based workflows and CI/CD.',
    ],
    technologies: ['Python', 'SQL', 'PostgreSQL', 'Pandas', 'Django', 'CI/CD'],
    current: true,
  },
  {
